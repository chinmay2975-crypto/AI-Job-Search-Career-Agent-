...
def serper_search(query: str, num_results: int = 10) -> list[dict]:
    """Raw Serper (Google search wrapper) call. Returns the 'organic' result list."""
...
def search_jobs(query: str, location: str = "", num_results: int = 10) -> list[dict]:
    ...
    return [_normalize_result(result) for result in serper_search(full_query, num_results)]
